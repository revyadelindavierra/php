...
if($_POST){
    ...
    if(empty($nama_siswa)){
        echo "<script>alert('nama siswa tidak bolehx kosong');location.href='tambah_siswa.php';</script>";
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan siswa');slocation.href='tambah_siswa.php';</script>";
        } else {
